 ...
 * @date    27 March 2019
 * @brief   Program demonstrates using UART to control the input and output ports of the Arduino.
 *
 * @details This program was made to run on the ATMEGA328p running at 16MHz. At boot, it sends out 
 * 			simplistic menu 
 */

/** @mainpage
 * @section Introduction
 *          This will serve as documentation for lab 4 for the CENG447: Embedded systems classes for 
 *			the Spring of 2019.
 *
 *          The <a href="main.c">source file</a> was compiled using avr-gcc and flashed on the ATMEGA328p 
 *			using the AVRDUDE utility and the arduino UNO as a programmer.
 *
 * @section Video
 * 			
